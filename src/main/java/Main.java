	...
	public static void main(String[] args) {
		if(!SKIP_TO_TESTS) {
			...
			do {
				...
				System.out.println("2 – Run simple tests on src.Parser.java");
				System.out.println("3 - Run custom code (see the code for src.Main.java)");
